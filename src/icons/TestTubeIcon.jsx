function TestTubeIcon({ size = 30 }) {
  return (
    <svg
      ...
      viewBox="0 0 128 128"
    >
      <circle cx="109.77" cy="11.02" r="4.66" fill="#7a11f1" />
      ...
      <circle cx="45.06" cy="76.96" r="5.06" fill="#7a11f1" />
      <circle cx="96.58" cy="37.04" r="4.76" fill="#7a11f1" />
      <circle cx="73.27" cy="57.3" r="2.93" fill="#fff" opacity=".69" />
      <circle cx="121.84" cy="12.01" r="2.17" fill="#7a11f1" />
      <circle cx="59.15" cy="72.54" r="4" fill="#7a11f1" />
      <circle cx="63.75" cy="61.12" r="1.54" fill="#7a11f1" />
